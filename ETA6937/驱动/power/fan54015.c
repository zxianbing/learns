...
void fan54015_init(void)
{
	...
	if (vendor_id == VENDOR_PSC54X5A) {
		...
		fan54015_sw_reset();
		fan54015_set_safety_vol(VSAFE);
		fan54015_set_safety_cur(ISAFE);
		fan54015_set_safety_vol(VSAFE);
		fan54015_set_safety_cur(ISAFE);		
		fan54015_set_value(FAN5405_REG_CONTROL1,
...
{
	if(fan54015_get_value(FAN5405_REG_CONTROL0,FAN5405_CE_N, FAN5405_CE_N_SHIFT) == 1){
			
			fan54015_set_value(FAN5405_REG_CONTROL0,FAN5405_CE_N,FAN5405_CE_N_SHIFT, 0);
			fan54015_set_value(FAN5405_REG_CONTROL0,FAN5405_CE_N,FAN5405_CE_N_SHIFT, 0);
		}
...
unsigned char fan54015_get_chg_current(void)
{
	...
	datal = fan54015_get_value(FAN5405_REG_IBAT,
				  FAN5405_IOCHARGE, FAN5405_IOCHARGE_SHIFT);
				  
	datah = fan54015_get_value(FAN5405_REG_SP_CHARGER,
				  ETA6937_IOCHARGE, ETA6937_IOCHARGE_SHIFT);
	datah =	datah * 8 + datal;	  
	return datah;
}
